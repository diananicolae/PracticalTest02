...
public class PracticalTest02MainActivity extends AppCompatActivity {
    ...
    private final GetBitcoinValueButtonClickListener getBitcoinValueButtonClickListener = new GetBitcoinValueButtonClickListener();

    private class GetBitcoinValueButtonClickListener implements Button.OnClickListener {
        ...
        public void onClick(View view) {
            ...
            bitcoinTextView.setText("");

            ClientThread clientThread = new ClientThread(clientAddress, Integer.parseInt(clientPort), coin, bitcoinTextView);
            clientThread.start();
        }
    }
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Button button = findViewById(R.id.get_bitcoin_value_button);
        button.setOnClickListener(getBitcoinValueButtonClickListener);
        bitcoinTextView = findViewById(R.id.bitcoin_text_view);
    }
