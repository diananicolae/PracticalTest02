...
public class ServerThread extends Thread {
    ...
    private final HashMap<String, BitcoinInformation> data;
    ...
    public synchronized void setData(String city, BitcoinInformation bitcoinInformation) {
        this.data.put(city, bitcoinInformation);
    }
